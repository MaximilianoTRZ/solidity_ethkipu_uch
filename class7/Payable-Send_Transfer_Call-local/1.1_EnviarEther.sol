...
¿Qué método deberías utilizar?
     - Call en combinación con el protector de reentrada (re-entrancy guard)es el método 
...
Protéjase contra la reentrada por
     ...
     - usando el modificador de guardia de reentrada (re-entrancy guard)
*/
...
contract ReceiveEther {
    ...
    //  se llama a la función Fallback cuando se envía a una dirección que no tiene ninguna función asociada
    fallback() external payable {}
...
contract SendEther {
    ...
    function sendViaCall(address payable _to) public payable {
        // Call devuelve un valor booleano que indica éxito o fracaso.
